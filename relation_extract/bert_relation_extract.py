# -*- coding: utf-8 -*-
"""
# @Time    : 2019/10/31 20:08
# @Author  : xiaoxiong
# @Email   : xyf_0704@sina.com
# @File    : bert_relation_extract.py
# @Software: PyCharm
# DESC : 基于bert的关系抽取
"""
import json
...
# config_path = r'D:\python\SomeNlp\lib\bert\chinese_wwm_ext_L-12_H-768_A-12\bert_config.json'
# checkpoint_path = r'D:\python\SomeNlp\lib\bert\chinese_wwm_ext_L-12_H-768_A-12\bert_model.ckpt'
# dict_path = r'D:\python\SomeNlp\lib\bert\chinese_wwm_ext_L-12_H-768_A-12\vocab.txt'
...
if not os.path.exists('./data/random_order_train_dev.json'):
    ...
    json.dump(
        random_order,
        open('./data/random_order_train_dev.json', 'w', encoding='utf-8'),
        indent=4
    )
else:
    random_order = json.load(open('./data/random_order_train_dev.json', encoding='utf-8'))
...
class Evaluate(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 > self.best:
            self.best = f1
            train_model.save_weights('./model/bert_best_model.weights')
...
if __name__ == '__main__':
    ...
    train_model.load_weights('./model/bert_best_model.weights')