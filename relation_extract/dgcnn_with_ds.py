# -*- coding: utf-8 -*-
"""
# @Time    : 2019/10/31 19:23
# @Author  : xiaoxiong
# @Email   : xyf_0704@sina.com
# @File    : dgcnn_with_ds.py
# @Software: PyCharm
# DESC : 加先验信息的关系抽取
"""
...
total_data = json.load(open('./data/train_data_vote_me.json'))
...
class Evaluate(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 > self.best:
            self.best = f1
            train_model.save_weights('./model/dgcnn_best_model_with_ds.weights')
        ...
        if epoch + 1 == 50 or (
            ...
            self.stage = 1
            train_model.load_weights('./model/dgcnn_best_model_with_ds.weights')
            EMAer.initialize()
